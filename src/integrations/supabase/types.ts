...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      app_role: "athlete" | "coach" | "admin" | "organization" | "medical_reviewer";
      athlete_state:
        | "UNREGISTERED"
        | "REGISTERED"
        | "ACTIVE"
      ...
      evaluation_status:
        ...
        | "AUTO_REJECTED"
        | "FAILED";
      hire_status: "REQUESTED" | "ACCEPTED" | "DECLINED" | "WITHDRAWN" | "ACTIVE" | "COMPLETED";
      match_status: "INVITED" | "ACCEPTED" | "DECLINED" | "SUBMITTED" | "WITHDRAWN";
